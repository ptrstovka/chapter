...
const form = useForm(() => ({
  ...
  client_id: props.provider?.configuration.clientId || '',
  client_secret: props.provider?.configuration.clientSecret || '',
  authorize_url: props.provider?.configuration.authorizeUrl || '',
  token_url: props.provider?.configuration.tokenUrl || '',
  user_url: props.provider?.configuration.userUrl || '',
  user_id_field: props.provider?.configuration.userIdField || '',
  user_email_field: props.provider?.configuration.userEmailField || '',
  user_name_field: props.provider?.configuration.userNameField || '',
  user_avatar_field: props.provider?.configuration.userAvatarField || '',
  login_button_title: props.provider?.configuration.loginButtonTitle || '',
  login_button_text_color: props.provider?.configuration.loginButtonTextColor || '',
  login_button_background_color: props.provider?.configuration.loginButtonBackgroundColor || '',
}))
